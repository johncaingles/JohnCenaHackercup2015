...
class PassengerLoad extends CI_Model {
...
//        $this->db->insert_batch('travel_items', $newTravelItems);
    ...
    function isPeakHour(){
        ...
        $query = $this->db->select("passenger_traffic_mrt." . $from);
        $query = $query->get_where('passenger_traffic_mrt', array('id' => (((int)$this->input->post('hour'))-3)) , 1000, 0);
